...
const featuredPool800w = [
  '/images/electrical-panel-upgrade-200a-800w.webp',
  '/images/electrician-at-work-800w.webp',
  '/images/hero-ev-charger-800w.webp',
  '/images/nema-14-50-outlet-install-800w.webp',
  '/images/commercial-ev-charging-station-800w.webp',
  '/images/sectional-conduit-wiring-800w.webp',
  '/images/emporia-ev-charger-install-800w.webp',
  '/images/ev-repair-diagnostic-800w.webp',
  '/images/solar-ev-integration-800w.webp',
  '/images/ford-lightning-charger-800w.webp',
  '/images/tesla-wall-connector-install-800w.webp',
  '/images/rivian-charger-install-800w.webp',
  '/images/vacation-rental-airbnb-charger-800w.webp'
];

const sectionalPool658w = [
  '/images/electrical-panel-upgrade-200a-658w.webp',
  '/images/electrician-at-work-658w.webp',
  '/images/hero-ev-charger-658w.webp',
  '/images/nema-14-50-outlet-install-658w.webp',
  '/images/commercial-ev-charging-station-658w.webp',
  '/images/sectional-conduit-wiring-658w.webp',
  '/images/emporia-ev-charger-install-658w.webp',
  '/images/ev-repair-diagnostic-658w.webp',
  '/images/solar-ev-integration-658w.webp',
  '/images/ford-lightning-charger-658w.webp',
  '/images/tesla-wall-connector-install-658w.webp',
  '/images/rivian-charger-install-658w.webp',
  '/images/vacation-rental-airbnb-charger-658w.webp'
];

function generateTopicArticle(slug, index) {
  const featuredImageSrc = featuredPool800w[index % featuredPool800w.length];
  const sectionalImageSrc = sectionalPool658w[(index + 4) % sectionalPool658w.length];
...
console.log('Successfully updated articleTopics.ts with 800w and 658w optimized image variants!');
